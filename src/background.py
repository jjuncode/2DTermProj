...
class BackGround:
    ...
    def __init__(self,_type):
        ...
        if BackGround.image_defeat == None :
            BackGround.image_defeat = load_image('resource/bg_result_defeat.jpg')

        if BackGround.image_background == None :
            BackGround.image_background = load_image('resource/bg_streetFighter2.png')

        if BackGround.image_win == None:
            BackGround.image_win = load_image('resource/bg_result_win.jpg')
